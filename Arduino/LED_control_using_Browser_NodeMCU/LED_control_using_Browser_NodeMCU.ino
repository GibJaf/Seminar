...
const char* ssid = "MyWifi_MyRules"; // SSID i.e. Service Set Identifier is the name of your WIFI
const char* password = "Jafars729820"; // Your Wifi password, in case you have open network comment the whole statement.
